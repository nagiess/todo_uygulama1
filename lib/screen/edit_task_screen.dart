...
class DuzeltScreen extends StatefulWidget {
  Task _task;
  DuzeltScreen(this._task, {super.key});

  @override
  State<DuzeltScreen> createState() => _DuzeltScreenState();
}

class _DuzeltScreenState extends State<DuzeltScreen> {
    ...
    return Row(
      ...
      children: [
        ElevatedButton(
          ...
          onPressed: () {
            FirestoreDatasource().UpdateTask(
